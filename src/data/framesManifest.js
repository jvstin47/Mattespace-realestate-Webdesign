/**
 * Frames Manifest — Cinematic Chapter Engine
 *
 * Folders map frame indices to physical directories on disk.
 * Chapters define the 7 playback sequences triggered by the user's scroll.
 */
...
export const CHAPTERS = [
  ...
  {
    id: 3,
    title: 'Exterior Day + Dining Terrace',
    startFrame: 366,
    endFrame: 741,
    caption: {
      label: 'ARCHITECTURAL FORM',
      headline: 'Where Space\nBecomes Home',
      description: 'Clean lines. Honest materials. Twilight dining.',
  ...
  {
    id: 6,
    title: 'Sunset Towers + Street Context',
    startFrame: 1273,
    endFrame: 1466,
    caption: {
      label: 'THE REVEAL',
      headline: 'Where the City\nMeets the Sky',
      description: 'Golden hour silhouettes and urban rhythm.',
